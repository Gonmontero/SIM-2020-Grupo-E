...
public class GeneradorCongruencial extends javax.swing.JFrame
{
    ...
    private ArrayList<BigDecimal> obtenerValoresEnDouble()
    {
        ArrayList<BigDecimal> ret = new ArrayList<>();
        for (int i = 0; i < _tmNumerosAleatorios.getRowCount(); i++)
        {
            ret.add(BigDecimal.valueOf(Double.parseDouble((String)_tmNumerosAleatorios.getValueAt(i, MetodoTableModel.COL_NUM_ALEATORIO))));
        }
        return ret;
    }
}
